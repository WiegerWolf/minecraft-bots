 ...
 *
 * When there's no village center established, the landscaper should loosely follow
 * the lumberjack to stay within VillageChat range and hear about:
 * - Village center location when it's established
 * - Terraform requests when farmers establish farms
 *
...
export class FollowLumberjack {
    ...
    async tick(bot: Bot, bb: LandscaperBlackboard): Promise<'success' | 'failure' | 'running'> {
